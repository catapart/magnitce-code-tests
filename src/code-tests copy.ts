...
import { CodeTests, expect, prompt, type Test, type TestResultType, type Tests  } from './api';
...
export class CodeTestsElement extends HTMLElement
{
    ...
    async loadTests(testsPath?: string)
    {
        ...
        try
        {
            ...
            if(beforeAll != null)
            {
                this.#hooks[Hook.BeforeAll] = beforeAll;
            ...
            if(afterAll != null)
            {
                this.#hooks[Hook.AfterAll] = afterAll;
            ...
            {
                this.#hooks[Hook.RequiredAfterAny] = requiredAfterAny;
